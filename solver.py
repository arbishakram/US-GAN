...
class Solver(object):
    ...
    def train(self):
        """Train SARGAN within a single dataset."""
        # Set data loader.
        ...
        for i in range(start_iters, self.num_iters):
            ...
            if (i+1) % self.n_critic == 0:
                ...
                # Backward and optimize.
                g_loss = g_loss_fake + self.lambda_rec * g_loss_rec + self.lambda_cls * g_loss_cls # + 10 * g_loss_PCP
                ...
                # loss['G/loss_pcp'] = g_loss_pcp.item()
            ...
            for i, (x_real, c_org) in enumerate(data_loader):
                ...
                for i in range(len(exp_list)):
                    for c_trg in c_trg_list:     
                          c_trg = c_trg_list[i]               
                          x_fake = self.G(x_real, c_trg)                  
                          result_path = os.path.join(self.result_dir, str(imgn)+'_sargan1_'+str(exp_list[i])+'.png')
